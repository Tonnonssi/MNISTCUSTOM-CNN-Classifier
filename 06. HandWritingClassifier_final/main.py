...
class MyApp(QMainWindow):
    def __init__(self):
        ...
        self.path_of_model = '/Users/ijimin/Desktop/Python Code/MNISTCUSTOM_CNN_Classifier/06. HandWritingClassifier_final/models/3x3_state.pth'
        # 여러가지
    ...
    def run_if_save_pushed(self):
        ...
        with open('/Users/ijimin/Desktop/Python Code/MNISTCUSTOM_CNN_Classifier/06. HandWritingClassifier_final/datafile/'+fname, 'wb') as f:
    ...
    def load_f(self):
        ...
        pre_lst = []
        f = open(f'/Users/ijimin/Desktop/Python Code/MNISTCUSTOM_CNN_Classifier/06. HandWritingClassifier_final/datafile/'+fname,'rb')
        while True:
            try:
